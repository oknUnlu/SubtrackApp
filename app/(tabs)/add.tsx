  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const isInstallmentPurchase =
        paymentMethod === "credit_card" && isInstallment && !isNaN(installmentCountNum) && installmentCountNum > 1;

      if (isInstallmentPurchase) {
        // Installment purchase: record it as a monthly expense spread across the
        // installment period instead of a single up-front transaction. The
        // monthly payment rows are generated by addInstallment.
        await addInstallment({
          ...
          paidCount: 0,
          monthlyAmount: parsedAmount / installmentCountNum,
